public class Solution {
    public double FindMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        while(low <= high) {
            ...
            // If  partitionX is 0, it means nothing is on the left side for nums1. Use -Infinity
            // If partitionX is m, it means nothing is on the right side for nums1. Use +Infinity
